  ...
  return (
    <>
      <section className="relative overflow-hidden bg-ivory py-12 sm:py-16 lg:py-20">
        ...
        <Container>
          <nav aria-label="Fil d’Ariane" className="mb-10 flex items-center gap-3 text-sm text-primary/70">
      ...
      <section className="border-y border-primary/10 bg-white py-20 sm:py-24">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
            ...
            <div className="space-y-5 text-lg leading-8 text-primary/70">
        ...
        <Container>
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-5 leading-7 text-primary/70">Les collaborations futures seront présentées uniquement lorsqu’elles seront confirmées.</p>
      ...
      <section className="relative overflow-hidden bg-terracotta py-20 text-white sm:py-24">
        ...
        <Container className="relative">
          <div className="grid items-end gap-8 lg:grid-cols-[1fr_auto]">
            <div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.18em] text-white">Poursuivre</p><h2 className="mt-5 font-display text-4xl font-semibold leading-tight sm:text-5xl">Découvrir les filières ciblées par Bilik Farm.</h2></div>
