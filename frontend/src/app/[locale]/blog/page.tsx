      ...
      <section className="relative overflow-hidden bg-ivory py-16 sm:py-20 lg:py-24">
        ...
        <Container>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_0.65fr] lg:items-end">
            ...
            <p className="text-lg leading-8 text-primary/65">Cette section sera publiée lorsque les premiers contenus officiels de Bilik Farm auront été validés.</p>
          </div>
        </Container>
      </section>
      <section className="border-y border-primary/10 bg-white py-24 sm:py-28">
        <Container>
          <div className="mx-auto max-w-3xl text-center"><p className="text-xs font-bold uppercase tracking-[0.18em] text-terracotta">En préparation</p><h2 className="mt-5 font-display text-4xl font-semibold text-primary sm:text-5xl">Aucun article officiel publié à ce jour.</h2><p className="mx-auto mt-6 max-w-xl leading-7 text-primary/60">Bilik Farm privilégie une communication progressive, fondée sur des informations confirmées.</p><Link href={`/${locale}/about`} className="btn-primary btn-lg mt-9">Découvrir le projet</Link></div>
        </Container>
      </section>
    </>
  );
