        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
            <div>
              ...
              <p className="mt-6 leading-7 text-primary/65">Utilisez le formulaire ou écrivez directement à l’adresse ci-dessous. Chaque message est transmis par email à Bilik Farm.</p>
